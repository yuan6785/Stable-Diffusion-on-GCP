...
# docker build -t sand:1.0 -f Dockerfile.finally.libo.supervisor  .  # 本地打包镜像--supervisor版本
...
docker tag sand:1.0 registry-intl.us-east-1.aliyuncs.com/talefun/stable-diffusion-images:v18
docker push registry-intl.us-east-1.aliyuncs.com/talefun/stable-diffusion-images:v18
----清理镜像
docker images
