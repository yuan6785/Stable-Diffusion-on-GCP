...
---------推送本地镜像到阿里云（记得修改版本号）-------美东(mac:v69, ubuntu:u12)--------
            docker login --username=yuanxiao@playnexx registry-intl.us-east-1.aliyuncs.com  # b*****1**
            docker tag sand:1.0 registry-intl.us-east-1.aliyuncs.com/talefun/stable-diffusion-images:u12
            docker push registry-intl.us-east-1.aliyuncs.com/talefun/stable-diffusion-images:u12
