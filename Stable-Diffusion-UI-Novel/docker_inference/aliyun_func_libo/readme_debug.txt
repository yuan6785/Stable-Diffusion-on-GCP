...
docker tag sand:1.0 registry-intl.us-east-1.aliyuncs.com/talefun/stable-diffusion-images:v67
docker push registry-intl.us-east-1.aliyuncs.com/talefun/stable-diffusion-images:v67
----清理镜像
docker images
