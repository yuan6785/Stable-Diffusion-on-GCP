...
# 记录一次测试----
# c-64898a1e-f45d4dac86a54d42be0d   2023-06-14 17:36:34  17:55最后一张图， 然后用非卡住docker的后台任务进行保活测试  18:38都没有释放，说明非卡住docker的后台任务可以保活（但是执行时间不能太长，不能有supervisor的web访问,看日志太耗api. 和其他非卡主docker的服务器的长时间的访问，长时间的需要前端页面轮询）
#####
